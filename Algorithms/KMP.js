...
// function stringMatch(str = "", subtring) {
//   let j = 0;
//   let i = 0;
//   let diff = str.length - subtring.length;
//   if (subtring.length === 0) return 0;
//   while (i <= diff) {
//     while (j < subtring.length) {
//       if (str[i + j] !== subtring[j]) break;
//       j++;
//     }
//     if (j === subtring.length) return i;
//     i++;
//   }
//   return;
// }

// console.log(stringMatch("abcdefg", "cde")); //1
//Time O(M*N)
